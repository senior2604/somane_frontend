...
import { 
  ...
  FiKey, FiLock, FiUnlock, FiMoreVertical
} from "react-icons/fi";
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Gestion des Groupes</h1>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm hover:shadow transition-shadow duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-600">Total des groupes</p>
          ...
          <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm hover:shadow transition-shadow duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-600">Avec permissions</p>
                <p className="text-lg font-bold text-green-600 mt-0.5">{stats.withPermissions}</p>
              </div>
          ...
          <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm hover:shadow transition-shadow duration-300">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-purple-600 mt-0.5">{stats.totalUsers}</p>
              </div>
              ...
              {currentGroupes.length === 0 ? (
                ...
                currentGroupes.map((group) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 border-r border-gray-200">
                      <div className="flex items-center gap-2">
                        <div className="p-1 bg-violet-100 rounded">
                          <FiFolder className="w-3 h-3 text-violet-700" />
                        </div>
                        <div>
                    ...
                    <td className="px-3 py-2 border-r border-gray-200">
                      <div className="flex flex-wrap gap-1">
                        {group.modules_autorises && group.modules_autorises.length > 0 ? (
                          <>
                            <span className="inline-flex px-1.5 py-0.5 rounded text-xs bg-gradient-to-r from-violet-50 to-violet-100 text-violet-700 font-medium border border-violet-200">
                              {group.modules_autorises.length} module(s)
                            </span>
                          </>
                        ) : (
                    ...
                    <td className="px-3 py-2 border-r border-gray-200">
                      <span className="inline-flex px-2 py-1 rounded text-xs font-medium bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 border border-green-200">
...
// MODAL DE DÉTAILS POUR LES GROUPES
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-violet-100 text-xs mt-0.5">{group.name}</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                ...
                <p className="text-sm text-gray-900 font-medium font-mono">#{group.id}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">{group.user_count || 0} membre(s)</p>
              </div>
              <div className="md:col-span-3">
                <p className="text-xs font-medium text-gray-500 mb-0.5">Description</p>
                <p className="text-sm text-gray-900">{group.description || 'Aucune description'}</p>
              </div>
            </div>
          </div>
          ...
          {group.modules_autorises && group.modules_autorises.length > 0 && (
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 border border-gray-200">
              ...
              <div className="flex flex-wrap gap-2">
                {availableModules
                  .filter(module => !group.modules_autorises.includes(module))
                  .map((module, idx) => (
                    <span key={idx} className="inline-flex px-3 py-1.5 rounded-lg text-sm bg-gradient-to-r from-gray-50 to-gray-100 text-gray-600 font-medium border border-gray-200">
                      {module}
                    </span>
                  ))}
              </div>
...
// COMPOSANT MODAL POUR LES GROUPES - FORMULAIRE COMPACT
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-3 z-50 backdrop-blur-sm">
      <div className="bg-white rounded-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          {/* Section 2: Modules Autorisés - COMPACT */}
          <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-lg p-3 border border-violet-100">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-1 h-4 bg-gradient-to-b from-violet-600 to-violet-400 rounded"></div>
