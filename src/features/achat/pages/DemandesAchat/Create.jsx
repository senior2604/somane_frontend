...
export default function DemandesAchatCreate() {
  ...
  const fetchReferenceData = useCallback(async () => {
    try {
      setLoading(true);
      const [utilisateursRes, departementsRes, societesRes] = await Promise.all([
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await apiClient.post('/achats/demandes-achat/', { ...formData, lignes });
