...
// ==========================================
// COMPOSANT LIGNE DE RÉPARTITION (version valeurs positives)
// ==========================================
...
// ==========================================
// COMPOSANT RÉCAPITULATIF (version valeurs positives)
// ==========================================
...
export default function TauxFiscauxEdit() {
  ...
  // Synchronisation des lignes avoir avec les lignes facture (valeurs positives uniquement)
  useEffect(() => {
  ...
  // ========================================
  // VALIDATION (version valeurs positives)
  // ========================================
  const validateForm = () => {
    const errors = [];
    ...
    // Vérifier que la base totale = 100%
    ...
    // Vérifier que la base totale = 100% (en valeur absolue, le signe sera géré par le backend)
  ...
  // ========================================
  // PRÉPARATION DES DONNÉES POUR API (valeurs positives uniquement)
  // ========================================
  const prepareDataForApi = useCallback(() => {
    ...
    // Pour la facture : on envoie les valeurs positives
    ...
    // Pour l'avoir : on envoie aussi les valeurs positives
