...
export default function CommandesClientCreate() {
  ...
  const fetchReferenceData = useCallback(async () => {
    try {
      setLoading(true);
      const [clientsRes, devisesRes, societesRes, utilisateursRes] = await Promise.all([
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await apiClient.post('/ventes/commandes-client/', { ...formData, lignes });
